...
data_production <- read.csv("~/Desktop/ie360/project/2022-06-02_production_weather/2022-06-02_production.csv",colClasses=c("Date",rep("numeric",2)))
tail(data_production)
data_weather <- read.csv("~/Desktop/ie360/project/2022-06-02_production_weather/2022-06-02_weather.csv")
...
plot(data_production$production[11113:11280],
     xlab = "Hour",
     ylab = "Production (MW)", #BU B?R?M DO?RU MU???
...
data_production_final <- read.csv("~/Desktop/ie360/project/actual production data.csv",colClasses=c("Date",rep("numeric",2)))
data_production_final$time <- 0:215

final_forecast <- read.csv("~/Desktop/ie360/project/final forecast data.csv",colClasses=c("Date",rep("numeric",2)))
